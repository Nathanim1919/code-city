...
export function LandingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const files = await fetchGitHubRepo(parsed.owner, parsed.repo, parsed.branch, (msg) => {
        setProgress(msg);
      });
      ...
      <div className="landing-content">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <form className="repo-form" onSubmit={handleSubmit}>
              ...
              <button type="submit" className="repo-submit" disabled={!repoUrl.trim()}>
            ...
            <div className="example-repos">
              <p className="example-label">Try these:</p>
            ...
            {/* Demo button */}
            <button className="demo-button" onClick={loadSampleProject}>
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 24"
            ...
            <p className="demo-hint">
              See a sample codebase with 20+ files to get a feel for CodeCity
            </p>
          </>
        )}
        ...
        <div className="landing-features">
          <div className="feature">
            ...
            <h3>Files = Buildings</h3>
            <p>Height shows complexity, width shows lines of code, color shows language</p>
          </div>
          <div className="feature">
            <div className="feature-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <h3>Imports = Bridges</h3>
            <p>Glowing arcs connect files that depend on each other</p>
          </div>
          <div className="feature">
            <div className="feature-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <p>Find any file or function and fly to it in the 3D city</p>
          </div>
        </div>
      </div>
    </div>
...
function parseGitHubUrl(url: string): { owner: string; repo: string; branch?: string } | null {
  ...
  let cleaned = url.replace(/\/$/, ""); // trim trailing slash
