  ...
  return (
    <div className="urp" ref={popupRef}>
      <div className="urp-header">
        ...
        <div className="urp-header-actions">
          <button
            className={`urp-refresh ${refreshing ? "urp-refresh--spin" : ""}`}
      ...
      <div className="urp-list">
        ...
        {error && <div className="urp-state urp-error">{error}</div>}
